...
public class ChiFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.chifragment,container,false);
        rcv = view.findViewById(R.id.rcvKhoanchi);
...
//        list.add(new Khoanthuchi("12312",date, (float) 200.0,"abc",1));
        ...
        list = khoanthuchiDao.getAll("Chi");
    ...
    public void dialog_insert(){
        ...
        arrayList = loaiThuDao.getAll("Chi");
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            ...
                            if(khoanthuchiDao.insert(khoanthuchi)){
                                list.clear();
                                list.addAll(khoanthuchiDao.getAll("Chi"));
